...
<section class="section-programacion mt-0">
     <h1 class="visually-hidden">Teatro Galería Café Libro</h1>
        ...
        <div class="row row-programacion justify-content-center">
            <?php foreach ($this->programacion as $key => $data) { ?>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4 col-programacion">
                    ...
                    <div class="card card-programacion">
                        <div class="div-img-programacion">
                            <img src="/images/<?php echo $programacion->programacion_imagen ?>"  alt="Teatro - Galería Café Libro <?php echo $programacion->programacion_nombre ?>" class="card-img-top card-img-programacion">
                        </div>
                ...
                <div class="boton-anteriores" align="center">
                    <a class="btn btn-anteriores" href="/page/anterioresTeatro">Eventos Anteriores</a>
                </div>
        </div>
</section>
