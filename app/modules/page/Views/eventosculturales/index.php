...
<div class="fondo-teatro" style="position: relative;">
    ...
    <div align="center" class="titulo-fotos-galeria">
        <h1>Eventos Culturales Galería Café Libro</h2>
    </div>
</div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4  col-programacion">
                    ...
                    <div class="card card-programacion">
                        <div class="div-img-programacion">
                            <img src="/images/<?php echo $programacion->programacion_imagen ?>"  alt="Eventos Culturales - Galería Café Libro <?php echo $programacion->programacion_nombre ?>" class="card-img-top card-img-programacion">
                        </div>
