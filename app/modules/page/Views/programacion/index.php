<h1 class="visually-hidden">Eventos Programación - Galería Café Libro</h1>


<div class="titulo-imagen-eventos">
    <img class="imagen-titulo" src="/skins/page/images/GCL-35.png" alt="Titulo Galería Café Libro - Programación">
</div>
        ...
        <div class="row row-programacion justify-content-center">
            <?php foreach ($this->programacion as $key => $data) { ?>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4  col-programacion">
                    ...
                    <div class="card card-programacion">
                        <div class="div-img-programacion">
                            <img src="/images/<?php echo $programacion->programacion_imagen ?>" alt="Programación Eventos - Galería Café Libro <?php echo $programacion->programacion_nombre ?>"  class="card-img-top card-img-programacion">
                        </div>
                ...
                <div class="boton-anteriores" align="center">
                    <a class="btn btn-anteriores" href="/page/anteriores">Eventos Anteriores</a>
                </div>
        </div>
</section>
...
<div class="programacion">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="evento">
                        ...
                        <div class="contenido-evento">
                            ...
                            <div style="height: 300px; overflow: auto;">Descripcion: <?php echo $programacion->programacion_descripcion ?></div>
                            <br>
                            <div class="row">
                                <?php if ($data["boleteria"]) { ?>
                                    <div class="col-md-6">
    ...
    <div class="boton-anteriores" align="center">
        <a class="btn btn-sm btn-anteriores" href="/page/anteriores">Eventos Anteriores</a>
    </div>
    <div class="container">
        <div align="center">
            <ul class="pagination justify-content-center">
