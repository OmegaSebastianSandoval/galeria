<div class="titulo-imagen-sedes">
    <img class="imagen-titulo" src="/skins/page/images/GCL-36.png" alt="Titulo Galeria">
</div>
<div class="container">
    ...
    <div class="row" style="justify-content: center;">
        <div class="col-sm-12 col-lg-6 evento">
            ...
            <img src="/images/<?php echo $this->detalle->programacion_imagen ?>" alt="Imagen Programacion" class="img-evento">
            ...
            <div class="descripcion-evento">
                ...
                <div class="accordion acordion-descripcion" id="acordionDescripcion">
                    <button class="btn btn-block text-left collapsed btn-acordion" type="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapseTwo" onclick="ocultarAcordion()">
                        <i class="fa-solid fa-message"> </i> <span id="mostrar-ocultar-descripcion"> Click aquí para mostrar descripción</span> <i class="fa-solid fa-angles-down"></i>
                    </button>
                    <div id="collapseTwo" class="collapse" aria-labelledby="info-descripcion" data-parent="#acordionDescripcion">
                        <div class="card-body">
                ...
                <div class="formulario-compra">
                    ...
                    <div class="padding-formulario">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <input name="documento" type="text" class="form-control form-control-sm" id="inputEmail3" placeholder="Documento" required>
                            </div>
                        </div>
                    </div>
                    <div class="padding-formulario">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <input name="nombre" type="text" class="form-control form-control-sm" id="inputEmail3" placeholder="Nombre" required>
                            </div>
                        </div>
                    </div>
                    <div class="padding-formulario">
                    ...
                    -->
                        <div class="resaltado">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-7">
                                            <input name="id-evento" id="id-evento" type="hidden" class="form-control form-control-sm" value="<?php echo $this->detalle->programacion_id ?>">

                                            <input name="codigo" id="codigo" type="text" class="form-control form-control-sm" id="inputPassword3" placeholder="Código Promocional">
                                        </div>
                                        <div class="col-5">
                        ...
                        <div class="div-checkTerminos">
                            <div class="row">
                                <div class="col-12">

                                    <input type="checkbox" checked id="checkTerminos" required>
                                    <label for="checkTerminos">Política de venta: </label> <button type="button" class="btn btn-politicas" data-toggle="modal" data-target="#modalPoliticaVenta">Ver más</button>
...
<script>
    function precios() {
        ...
        $.get("/page/programacion/precios?id=" + boleta, function(resultado) {
            res=JSON.parse(resultado)
           
            var cantidaboletas = Number(res.cantidad);
    ...
    function ocultarAcordion() {
        ...
        $('#collapseTwo').on('shown.bs.collapse', function() {
            span.innerHTML = `<span>Click aquí para ocultar descripción</span>`

        }).on('hidden.bs.collapse', function() {
            span.innerHTML = `<span>Click aquí para mostrar descripción</span>`
