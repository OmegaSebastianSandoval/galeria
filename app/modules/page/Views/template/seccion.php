<section class="contenedor-seccion <?php echo 'contenedor_' . $contenedor->contenido_id ?>" style="background-image:url(/images/<?php echo $contenedor->contenido_fondo_imagen; ?>); background-color:<?php echo $contenedor->contenido_fondo_color; ?>;">

	<div class="<?php if ($contenedor->contenido_columna_espacios == 3 || $contenedor->contenido_columna_espacios == 4) { ?> container <?php echo 'container_' . $contenedor->contenido_id ?><?php } ?>">
		...
		<?php if (count($rescontenido['hijos']) > 0) { ?>
			<div class="row <?php if ($contenedor->contenido_columna_alineacion == 2) { ?>justify-content-center <?php } else if ($contenedor->contenido_columna_alineacion == 3) { ?> justify-content-end  <?php } else { ?> justify-content-start <?php } ?> <?php if ($contenedor->contenido_columna_espacios == 2 || $contenedor->contenido_columna_espacios == 4) { ?> no-gutters <?php } ?>">
				...
				<?php foreach ($rescontenido['hijos'] as $key => $rescolumna) : ?>
					...
					<div class="<?php echo 'divSedes_' . $contenedor->contenido_id ?> <?php echo $columna->contenido_columna; ?>">
