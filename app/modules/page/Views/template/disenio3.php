<div class="caja-contenido-simple" style="background-color: <?php if ($contenido->contenido_fondo_color) {
	...
	<?php if ($contenido->contenido_imagen) { ?>
		<div class="imagen-contenido">
			<div class="div-imagen-contenido"> <img class="imagen-contenido" src="/images/<?php echo $contenido->contenido_imagen; ?>"></div>
		</div>
	<?php } ?>
	<div>
