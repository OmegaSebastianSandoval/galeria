...
<img src="/images/<?php echo $this->banner->publicidad_imagen?>" alt="logo teatro" style="position: absolute;
    width: 100%;
    height: 392px;
    top: 0;
    margin-top: -153px;">
    ...
    <div align="center" class="titulo-fotos-galeria">
        <h2>Teatro en el café</h2>
    </div>
</div>
<section class="section-programacion">
