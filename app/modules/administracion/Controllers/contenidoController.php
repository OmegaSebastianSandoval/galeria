...
class Administracion_contenidoController extends Administracion_mainController
{
	...
	public function indexAction()
	{
		...
		$order = "orden DESC";
		$list = $this->mainModel->getList("$filters AND contenido_seccion != '2'",$order);
		$amount = $this->pages;
		...
		$this->_view->lists = $this->mainModel->getListPages("$filters AND contenido_seccion != '2'",$order,$start,$amount);
