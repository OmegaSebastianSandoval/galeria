...
class Administracion_validacionboletaController extends Administracion_mainController
{
	...
	{
	    $this->setLayout('administracion_validador');
		$botonerasuperiorvalidador = $this->_view->getRoutPHP('modules/administracion/Views/partials/botonerasuperiorvalidador.php');
		$this->getLayout()->setData("panel_header", $botonerasuperiorvalidador);
	...
	public function updateAction()
	{
		...
		$this->mainModel->editField($id,  'boleta_compra_fechavalidacion', $fechaactual);
