...
class Administracion_informacionController extends Administracion_mainController
{
	...
	private function getData()
	{
		...
		$data['info_pagina_tiktok'] = $this->_getSanitizedParam("info_pagina_tiktok");
		...
		$data['info_pagina_titulo_politica_manejo_datos'] = $this->_getSanitizedParam("info_pagina_titulo_politica_manejo_datos");
		$data['info_pagina_descripcion_politica_manejo_datos'] = $this->_getSanitizedParamHtml("info_pagina_descripcion_politica_manejo_datos");
		return $data;
	}
}