<?php 
/**
* clase que genera la insercion y edicion  de boletatipo en la base de datos
*/
class Administracion_Model_DbTable_Boletatipo extends Db_Table
{
	...
	/**
	 * insert recibe la informacion de un boletatipo y la inserta en la base de datos
	...
	/**
	 * update Recibe la informacion de un boletatipo  y actualiza la informacion en la base de datos
