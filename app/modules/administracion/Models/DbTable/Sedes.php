...
class Administracion_Model_DbTable_Sedes extends Db_Table
{
	...
	public function insert($data){
		...
		$query = "INSERT INTO sedes( sede_estado, sede_nombre, sede_telefono, sede_direccion, sede_imagen, sede_descripcion) VALUES ( '$sede_estado', '$sede_nombre', '$sede_telefono', '$sede_direccion', '$sede_imagen', '$sede_descripcion')";
	...
	public function update($data,$id){
		...
		$sede_imagen = $data['sede_imagen'];
		$sede_descripcion = $data['sede_descripcion'];
		$query = "UPDATE sedes SET  sede_estado = '$sede_estado', sede_nombre = '$sede_nombre', sede_telefono = '$sede_telefono', sede_direccion = '$sede_direccion', sede_imagen = '$sede_imagen', sede_descripcion = '$sede_descripcion' WHERE sede_id = '".$id."'";
		$res = $this->_conn->query($query);
	}
}