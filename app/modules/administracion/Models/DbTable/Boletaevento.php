<?php 
/**
* clase que genera la insercion y edicion  de boletaevento en la base de datos
*/
class Administracion_Model_DbTable_Boletaevento extends Db_Table
{
	...
	/**
	 * insert recibe la informacion de un boletaevento y la inserta en la base de datos
	...
	/**
	 * update Recibe la informacion de un boletaevento  y actualiza la informacion en la base de datos
