...
class Administracion_Model_DbTable_Informacion extends Db_Table
{
	...
	public function insert($data){
		...
		$info_pagina_tiktok = $data['info_pagina_tiktok'];
		...
		$info_pagina_titulo_politica_manejo_datos = $data['info_pagina_titulo_politica_manejo_datos'];
		$info_pagina_descripcion_politica_manejo_datos = $data['info_pagina_descripcion_politica_manejo_datos'];
		$query = "INSERT INTO info_pagina( info_pagina_facebook, info_pagina_instagram, info_pagina_twitter, info_pagina_pinterest, info_pagina_youtube, info_pagina_flickr, info_pagina_linkedin, info_pagina_google, info_pagina_telefono, info_pagina_whatsapp, info_pagina_tiktok, info_pagina_correos_contacto, info_pagina_direccion_contacto, info_pagina_informacion_contacto, info_pagina_informacion_contacto_footer, info_pagina_latitud, info_pagina_longitud, info_pagina_zoom, info_pagina_descripcion, info_pagina_tags, info_pagina_robot, info_pagina_sitemap, info_pagina_scripts, info_pagina_metricas, info_pagina_titulo_politica_manejo_datos, info_pagina_descripcion_politica_manejo_datos) VALUES ( '$info_pagina_facebook', '$info_pagina_instagram', '$info_pagina_twitter', '$info_pagina_pinterest', '$info_pagina_youtube', '$info_pagina_flickr', '$info_pagina_linkedin', '$info_pagina_google', '$info_pagina_telefono', '$info_pagina_whatsapp', '$info_pagina_tiktok', '$info_pagina_correos_contacto', '$info_pagina_direccion_contacto', '$info_pagina_informacion_contacto', '$info_pagina_informacion_contacto_footer', '$info_pagina_latitud', '$info_pagina_longitud', '$info_pagina_zoom', '$info_pagina_descripcion', '$info_pagina_tags', '$info_pagina_robot', '$info_pagina_sitemap', '$info_pagina_scripts', '$info_pagina_metricas', $info_pagina_titulo_politica_manejo_datos, $info_pagina_descripcion_politica_manejo_datos)";
