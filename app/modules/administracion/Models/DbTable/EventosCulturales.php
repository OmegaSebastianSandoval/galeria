 ...
 */
class Administracion_Model_DbTable_EventosCulturales extends Db_Table
{
	/**
	...
	public function insert($data)
	{
		...
		$programacion_tipoevento = 'Eventos';
	...
	public function update($data, $id)
	{
		...
		$query = "UPDATE programacion SET  programacion_tipoevento = 'Eventos', programacion_nombre = '$programacion_nombre', programacion_imagen = '$programacion_imagen', programacion_costo = '$programacion_costo', programacion_fecha = '$programacion_fecha', programacion_hora = '$programacion_hora', programacion_lugar = '$programacion_lugar', programacion_descripcion = '$programacion_descripcion', programacion_titulo_politica = '$programacion_titulo_politica', programacion_descripcion_politica = '$programacion_descripcion_politica' WHERE programacion_id = '" . $id . "'";
		$res = $this->_conn->query($query);
	}
}
