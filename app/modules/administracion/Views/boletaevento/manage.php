    ...
    <div class="container-fluid">
    	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform; ?>" data-toggle="validator">
    			...
    			<div class="row">
    				...
    				<div class="col-12 form-group">
    					...
    					<label class="input-group">
    						...
    						<input type="text" value="<?php if ($this->content->boleta_evento_fechalimite) {
																						...
																						echo date('Y-m-d');
																					} ?>" name="boleta_evento_fechalimite" id="boleta_evento_fechalimite" class="form-control" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-language="es">
    					</label>
    					<div class="help-block with-errors"></div>
    				</div>
    				<div class="col-4 form-group">
    					...
    					<label class="input-group  timepicker">
    						<input data-role="timepicker" value="<?php if ($this->content->boleta_evento_horalimite) {
																												echo $this->content->boleta_evento_horalimite;
																											} else {
																												echo date('H:i:s');
																											} ?>" name="boleta_evento_horalimite" id="boleta_evento_horalimite">
    					</label>
    					<div class="help-block with-errors"></div>
    				</div>
    		...
    		<div class="botones-acciones">
    			...
    			<a href="<?php echo $this->route; ?>?evento=<?php if ($this->content->boleta_evento_evento) {
																												echo $this->content->boleta_evento_evento;
																											} else {
																												echo $this->evento;
