		...
		<div class="col-9 col-xl-10">
			<div class="div-dashboard">
				...
				<div align="center">
					...
					<div align="center" class="redes">
						<div><img src="/skins/administracion/images/tiktok.png"></div>
		...
		<div class="pading-dashboard">
			...
			<table class="table table-bordered">
				<tbody>
					...
					<tr>
						<td><?php echo $this->info->info_pagina_titulo_politica_manejo_datos; ?></td>
					</tr>
					<tr>
						<th>Descripción</th>
					</tr>
					<tr>
						<td><?php echo $this->info->info_pagina_descripcion_politica_manejo_datos; ?></td>
					</tr>
