			...
			<?php if ($tipo == 4 || $this->contentpadre->contenido_tipo == 2) { ?>
				<div class="col-12 form-group">
					...
					<div class="row">
						...
						<div class="col-2">
							<label class="radio-col">
								<input type="radio" value="col-sm-12 col-md-6 col-lg-6" <?php if ($this->content->contenido_columna == 'col-sm-12 col-md-6 col-lg-6') { ?> checked <?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
								<span>
						...
						<div class="col-2">
							<label class="radio-col">
								<input type="radio" value="col-sm-12 col-md-6 col-lg-4" <?php if ($this->content->contenido_columna == 'col-sm-12 col-md-6 col-lg-4') { ?> checked <?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
								<span>
						...
						<div class="col-2">
							<label class="radio-col">
								<input type="radio" value="col-sm-12 col-md-3 col-lg-3" <?php if ($this->content->contenido_columna == 'col-sm-12 col-md-3 col-lg-3') { ?> checked <?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
								<span>
