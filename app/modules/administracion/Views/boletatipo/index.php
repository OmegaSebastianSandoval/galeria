        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="boleta_tipo_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'boleta_tipo_nombre') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->boleta_tipo_id; ?>
					<tr>
						<td><?=$content->boleta_tipo_nombre;?></td>
						<td class="text-right">
							<div>
