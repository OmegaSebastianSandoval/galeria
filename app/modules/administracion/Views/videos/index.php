        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="videos_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'videos_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Link</label>
		            ...
		            <input type="text" class="form-control" name="videos_link" value="<?php echo $this->getObjectVariable($this->filters, 'videos_link') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
	                <label>Fecha</label>
	                ...
	                <input type="text" class="form-control" name="videos_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'videos_fecha') ?>"></input>
	                    </label>
	            </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->videos_id; ?>
					<tr>
						<td><?=$content->videos_titulo;?></td>
						<td><?=$content->videos_link;?></td>
						<td><?=$content->videos_fecha;?></td>
						<td>
