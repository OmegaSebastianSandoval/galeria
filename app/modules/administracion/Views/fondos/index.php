        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="fondo_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'fondo_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Seccion</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="fondo_seccion">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_fondo_seccion as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'fondo_seccion') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="fondo_fondo" value="<?php echo $this->getObjectVariable($this->filters, 'fondo_fondo') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->fondos_id; ?>
					<tr>
						<td><?=$content->fondo_nombre;?></td>
						<td><?= $this->list_fondo_seccion[$content->fondo_seccion];?>
						<td>
							<?php if($content->fondo_fondo) { ?>
								<img src="/images/<?= $content->fondo_fondo; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->fondo_fondo; ?></div>
						</td>
						<td>
