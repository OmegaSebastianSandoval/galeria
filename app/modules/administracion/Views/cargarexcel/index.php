        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="archivodocumento" value="<?php echo $this->getObjectVariable($this->filters, 'archivodocumento') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->archivo_id; ?>
					<tr>
						<td><?=$content->archivodocumento;?></td>
						<td>
