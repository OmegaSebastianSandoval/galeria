            ...
            <div class="row">
				...
				<div class="col-3">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="fotos_album">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_fotos_album as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'fotos_album') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	    ...
	    <div class="franja-paginas">
		    <div class="row">
		    	...
		    	<div class="col-5 d-flex gap-2 justify-content-end ">
					...
					<div class="text-right"><a class="btn btn-sm btn-warning" href="/administracion/cargarexcel/manage?id=1"> <i class="fa-solid fa-file-excel"></i> Cargar  archivo</a></div>
		    		<div class="text-right"><a class="btn btn-sm btn-primary" href="<?php echo $this->route."\importarfotos"; ?>"> <i class="fas fa-images"></i> Cargar  fotos</a></div>
		    	
				</div>
		    </div>
	    </div>
		<?php if ($this->error_carga && $this->error_type) { ?>
                <div class="alert alert-<?php echo $this->error_type ?> text-center mt-3" role="alert" >
                    <?php echo $this->error_carga ?>
                </div>
            <?php } ?>
			...
			<tbody>
				...
				<?php $id =  $content->fotos_id; ?>
					<tr>
						...
						<td><?= $this->list_fotos_album[$content->fotos_album];?>
						<td>
