        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="sede_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'sede_nombre') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->sede_id; ?>
					<tr>
						<td><?=$content->sede_nombre;?></td>
						<td>
