			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<select class="form-control" name="menu_seccion">
							<option value="">Todas</option>
							<?php foreach ($this->list_menu_seccion as $key => $value) : ?>
								<option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'menu_seccion') ==  $key) {
																	echo "selected";
																} ?>><?= $value; ?></option>
							<?php endforeach ?>
						</select>
				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="menu_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'menu_nombre') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php $id =  $content->menu_id; ?>
						<tr>
							<td><?= $this->list_menu_seccion[$content->menu_seccion]; ?>
							<td><?= $content->menu_nombre; ?></td>
							<td>
							<?php if($content->menu_imagen) { ?>
								<img src="/images/<?= $content->menu_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->menu_imagen; ?></div>
						</td>
							<td>
