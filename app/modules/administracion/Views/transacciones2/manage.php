		...
		<div class="content-dashboard">
			...
			<div class="row">
				<div class="col-12 form-group">
					<label for="boleta_compra_tipoboleta"  class="control-label">boleta_compra_tipoboleta</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono  fondo-morado " ><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" value="<?= $this->content->boleta_compra_tipoboleta; ?>" name="boleta_compra_tipoboleta" id="boleta_compra_tipoboleta" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
					<label for="boleta_compra_cantidad"  class="control-label">boleta_compra_cantidad</label>
					<label class="input-group">
						<div class="input-group-prepend">
				...
				<div class="col-12 form-group">
					<label for="boleta_compran_nombre"  class="control-label">boleta_compran_nombre</label>
					<label class="input-group">
						<div class="input-group-prepend">
