				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<select class="form-control" id="evento" name="evento">
							<option value="" disabled selected>Seleccione</option>
							<?php foreach ($this->eventos as $key => $value) { ?>
								<option value="<?php echo $value->programacion_nombre ?>"><?php echo $value->programacion_nombre ?></option>
							<?php } ?>
						</select>
					</label>
				</div>
			...
			<table class=" table table-striped  table-hover table-administrator text-left" style="font-size: 11px;">
				...
				<tbody>
					...
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							<td style=""><?= $content->programacion_nombre; ?></td>
							<td style=""><?= $content->programacion_fecha; ?></td>
							
							<td style=""><?= $content->cantidad_total; ?></td>
							<td style=""><?= $content->vendor; ?></td>
							<!--
