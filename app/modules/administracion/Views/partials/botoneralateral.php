...
<?php } else { ?>
	<ul>
		...
		<li <?php if ($this->botonpanel == 33) { ?>class="activo" <?php } ?>><a href="/administracion/eventosculturales"><i class="fas fa-file-invoice"></i> Administrar Eventos Culturales</a></li>
		...
		<li <?php if ($this->botonpanel == 12) { ?>class="activo" <?php } ?>><a href="/administracion/blog"><i class="fas fa-file-invoice"></i> Administrar Noticias</a></li>
		...
		<li <?php if ($this->botonpanel == 34) { ?>class="activo" <?php } ?>><a href="/administracion/programacion/infoticekts?cleanfilter=1"><i class="fas fa-file-invoice"></i> Información Tickets</a></li>
		<li <?php if ($this->botonpanel == 20) { ?>class="activo" <?php } ?>><a href="/administracion/transacciones2"><i class="fas fa-file-invoice"></i>Consulta boletería</a></li>
