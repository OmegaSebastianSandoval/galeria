...
<div class="container-fluid">
	<form class="text-left" enctype="multipart/form-data" data-toggle="validator">
			...
			<div class="row">
				...
				<div class="col-3 form-group">
					...
					<label class="input-group">
						...
						<input class="form-control <?= $this->content->boleta_compra_validacionentrada == 1 ? 'border border-success  mb-2 bg-success text-white' : '' ?>" type="text" value="<?= $this->content->boleta_compra_validacionentrada == 1 ? 'Entrada validada' : 'Entrada sin validar' ?>" name="" id="" >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-3 form-group">
						<label for="boleta_compra_fechavalidacion" class="control-label">Fecha de validación de la entrada</label>
						<label class="input-group">
							<div class="input-group-prepend">
								<span class="fondo-azul-claro "></i></span>
							</div>
							<input type="text" value="<?= $this->content->boleta_compra_fechavalidacion ?>" name="boleta_compra_fechavalidacion" id="boleta_compra_fechavalidacion" class="form-control">
						</label>
						<div class="help-block with-errors"></div>
					</div>
			</div>
