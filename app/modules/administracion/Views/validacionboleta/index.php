	...
	<div class="content-dashboard">
		<div class="franja-paginas">
			<div class="row">
				...
				<div class="col-6 col-md-3">
					<div class="text-right"><a class="btn btn-sm btn-success" href="<?php echo $this->route . "\manage"; ?>"> <i class="fas fa-plus-square"></i> Validar Boleta</a></div>
				</div>
			</div>
		</div>
		<div class="content-table table-responsive">
			<table class=" w-100 table table-striped  table-hover table-administrator tabla-validar text-left" style="font-size: 11px;">
				<thead class=" w-100 ">
					<tr class=" w-100 ">
						<td>Evento</td>
						<td>Tipo boleta</td>
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						-->
							...
							<td style="font-size: 12px;"><?= number_format($content->boleta_compra_total); ?></td>
							<td style="font-size: 12px;"><?= $content->validacion2; ?></td>
							<td style="font-size: 12px;"><?= $content->vendor; ?></td>
							<td class="text-right">
								<div>
									<a class="btn btn-azul btn-sm" href="<?php echo $this->route; ?>/detalleboletavalidada?id=<?= $id ?>" data-toggle="tooltip" data-placement="top" title="Detalle"><i class="fas fa-eye"></i></a>
