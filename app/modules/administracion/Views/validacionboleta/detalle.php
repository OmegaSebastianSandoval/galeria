	...
	<form class="text-left" method="post" action="<?php echo $this->routeform; ?>" enctype="multipart/form-data" data-toggle="validator">
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="col-12 col-md-3 form-group d-none">
				...
				<?php if ($this->content->boleta_compra_validacionentrada == 1) { ?>
					...
					<div class="col-12 col-md-3 form-group">
						<label for="" class="control-label">Fecha de validación de la entrada</label>
						<label class="input-group">
							<div class="input-group-prepend">
								<span class="fondo-azul-claro "></i></span>
							</div>
							<input type="text" value="<?= $this->content->boleta_compra_fechavalidacion ?>" name="" id="" class="form-control">
						</label>
						<div class="help-block with-errors"></div>
					</div>
				<?php }  ?>
