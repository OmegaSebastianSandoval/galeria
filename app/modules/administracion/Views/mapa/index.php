        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="mapa_latitud" value="<?php echo $this->getObjectVariable($this->filters, 'mapa_latitud') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="mapa_longitud" value="<?php echo $this->getObjectVariable($this->filters, 'mapa_longitud') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->mapa_id; ?>
					<tr>
						<td><?=$content->mapa_latitud;?></td>
						<td><?=$content->mapa_longitud;?></td>
						<td>
