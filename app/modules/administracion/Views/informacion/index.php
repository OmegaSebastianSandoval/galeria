			...
			<div align="center" class="pading-dashboard">
				...
				<div class="row">
					...
					<div class="col-6 form-group">
						<div class="input-group">
							<div class="input-group-prepend ">
								<span class="input-group-text input-icono fondo-youtube"><i class="fa-brands fa-tiktok"></i></span>
							</div>
							<input type="text" value="<?= $this->content->info_pagina_tiktok; ?>" name="info_pagina_tiktok" id="info_pagina_tiktok" class="form-control">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12">
						<div><label>Título</label>
							...
							<input type="text" name="info_pagina_titulo_politica_manejo_datos" id="info_pagina_titulo_politica_manejo_datos" class="form-control" value="<?= $this->content->info_pagina_titulo_politica_manejo_datos; ?>">
						</div>
						<div style="margin-top:2%;">
							<label>Descripción</label>
							<textarea name="info_pagina_descripcion_politica_manejo_datos" id="info_pagina_descripcion_politica_manejo_datos" class="form-control tinyeditor" rows="10"><?= $this->content->info_pagina_descripcion_politica_manejo_datos; ?></textarea>
